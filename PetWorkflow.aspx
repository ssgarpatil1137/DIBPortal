<%@ Page Title="PET Request" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
...
/* 1. PET Request Details — Main Request Information */
...
<div class="ux-page-head">
    <div>
        <div class="ux-title"><i class="bi bi-file-earmark-text"></i> Create Project &amp; PET Request</div>
    ...
    <div class="ux-actions">
        ...
        <asp:Button ID="btnDeleteThisPet" runat="server" CssClass="btn btn-sm btn-danger"
            Text="Delete This PET Request" OnClientClick="$('#petFormDelModal').modal('show');return false;"
...
<div class="tab-pane <%= TabPane("pet") %>" id="tabPet">
    ...
    <div class="card-panel panel-spend-request" style="margin-bottom:14px;">
        <div class="card-panel-hdr"><i class="bi bi-pencil-square"></i> Create PET Request</div>
        <div class="card-panel-body">
            <table class="table jira-detail-tbl">
                <tbody>
                    ...
                    <% } %>
                    <tr>
                        <td class="lbl"><i class="bi bi-key"></i>Demand ID# <span style="color:#dc2626;">*</span></td>
                        <td class="val">
                    ...
                    <tr>
                        <td class="lbl"><i class="bi bi-person-check"></i>Reviewer <small style="color:#64748b;">(optional)</small></td>
                        <td class="val">
                    ...
                    <tr>
                        <td class="lbl"><i class="bi bi-diagram-3"></i>Vertical</td>
                        <td class="val">
                            <asp:TextBox ID="txtVertical" runat="server" CssClass="form-control" />
                        </td>
                        <td class="lbl"><i class="bi bi-window-stack"></i>Applications</td>
                        <td class="val">
                            <asp:TextBox ID="txtApplications" runat="server" CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td class="lbl" colspan="1"><i class="bi bi-card-text"></i>Reference No <span style="color:#dc2626;">*</span></td>
            ...
            <asp:Panel ID="pnlCapexAmt" runat="server" Visible="false">
                <div class="amt-panel">
                    ...
                    <div class="budget-panel-row-4">
                        <div class="bgt-budget">  <div class="budget-label">Total Budget</div>  <div class="budget-val"><asp:Literal ID="litCapexBudget"    runat="server" Text="0" /></div></div>
                        ...
                        <div class="bgt-avail">   <div class="budget-label">Remaining</div>  <div class="budget-val"><asp:Literal ID="litCapexAvail"     runat="server" Text="0" /></div></div>
                    </div>
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="pnlOpexAmt" runat="server" Visible="false">
                <div class="amt-panel opex-panel">
                    ...
                    <div class="budget-panel-row">
                        <div class="bgt-budget">  <div class="budget-label">Total Budget</div>  <div class="budget-val"><asp:Literal ID="litOpexBudget"    runat="server" Text="0" /></div></div>
                        ...
                        <div class="bgt-avail">   <div class="budget-label">Remaining</div>  <div class="budget-val"><asp:Literal ID="litOpexAvail"     runat="server" Text="0" /></div></div>
            ...
            <asp:Panel ID="pnlInlineSpendLines" runat="server" Visible="false" CssClass="card-panel panel-spend-request spend-line-entry">
                <div class="card-panel-hdr">
                    <i class="bi bi-list-ul"></i> Add Spend Line
                    <small style="font-weight:400;color:#2563eb;">&mdash; <%= Server.HtmlEncode(string.IsNullOrEmpty(PetRefNo) ? "Staged until Save Project & PET" : PetRefNo) %></small>
                </div>
                <div class="card-panel-body">
                    <asp:Panel ID="pnlInlineLineEditor" runat="server">
                    ...
                    <div style="overflow-x:auto;">
                        <asp:GridView ID="gvLines" runat="server" AutoGenerateColumns="false"
                            ...
                            EmptyDataText="No PET lines staged yet.">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="gv-acts">
                                            ...
                                            <asp:LinkButton runat="server" CssClass="btn btn-xs btn-danger"
                                                ...
                                                OnClientClick="return confirm('Delete this PET line?')">
            ...
            <div class="ux-form-actions">
                <asp:Button ID="btnCancelPet" runat="server" CssClass="btn btn-default"
                    Text="Cancel" OnClick="btnCancelPet_Click" CausesValidation="false" />
                <asp:Button ID="btnSaveHeader" runat="server" CssClass="btn btn-primary"
                    Text="Save Project &amp; PET" OnClick="btnSaveHeader_Click" />
            </div>
            <% } %>
        </div>
    </div>
    ...
    <div class="row project-overview-stack">
        <div class="col-md-6">
            <div class="card-panel panel-spend-request">
                <div class="card-panel-hdr"><i class="bi bi-file-earmark-text"></i> PET Requests for this Project <small style="font-weight:400;color:#94a3b8;">(including Draft)</small></div>
                <div class="card-panel-body" style="padding:0;overflow-x:auto;">
                    <asp:GridView ID="gvProjectPets" runat="server" AutoGenerateColumns="false"
                        CssClass="dfm-table" GridLines="None" EmptyDataText="No PET Requests yet for this project.">
                        <Columns>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background:#2F5597;color:#fff;">
                    ...
                    <h4 class="modal-title"><i class="bi bi-file-earmark-text"></i> PET Request</h4>
                </div>
                <div class="modal-body">
                    <iframe id="petWorkflowFrame" title="PET Request"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Submit PET Request -->
    <% if (CanEditSpendLines && CurrentPetFormId > 0) { %>
    <div style="margin-top:14px;padding:14px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;">
        ...
        <p style="font-size:.85em;color:#64748b;margin:4px 0 10px;">
            Submitting will send the PET Request
        ...
        <asp:Button ID="btnSubmitPet" runat="server" CssClass="btn btn-warning" Text="Submit PET Request for Approval"
            OnClick="btnSubmitPet_Click" OnClientClick="return confirm('Submit this PET Request for approval?');" />
        <% } else { %>
        <p style="font-size:.85em;color:#92400e;margin:4px 0 0;background:#fef3c7;border:1px solid #fde68a;border-radius:6px;padding:8px 10px;">
            ...
            Select an Approver above and click <strong>Save Project &amp; PET</strong> if you want to submit it for approval.
        </p>
        <% } %>
    </div>
    <% } %>
...
<div class="tab-pane <%= TabPane("approval") %>" id="tabApproval">
    ...
    <div class="decision-panel" style="margin-top:12px;">
        ...
        <div class="decision-btns">
            <asp:Button ID="btnApprove"  runat="server" CssClass="btn btn-success btn-lg" Text="Approve"   OnClick="btnApprove_Click"  OnClientClick="return confirm('Approve this PET Request?');" />
            <asp:Button ID="btnReject"   runat="server" CssClass="btn btn-danger btn-lg"  Text="Reject"    OnClick="btnReject_Click"   OnClientClick="return confirm('Reject this PET Request?');" />
    ...
    <div class="card-panel panel-spend-request">
        ...
        <div class="card-panel-body">
            ...
            <div class="alert alert-warning" style="font-size:.88em;">
                <i class="bi bi-lock-fill"></i> <strong>Locked:</strong> CSV import is disabled while the PET Request is in <strong><%= CurrentStatus %></strong> state.
    ...
    <div class="modal-dialog" role="document" style="max-width:460px;">
        <div class="modal-content">
            <div class="modal-header" style="background:#b91c1c;color:#fff;">
                <button type="button" class="close" data-dismiss="modal" style="color:#fff;opacity:.8;">&times;</button>
                <h4 class="modal-title"><i class="bi bi-exclamation-triangle-fill"></i> Confirm Delete PET Request</h4>
            </div>
            <div class="modal-body" style="padding:24px;text-align:center;">
                ...
                <p style="font-size:.82em;color:#64748b;margin-top:8px;">The PET Request will be marked as <strong>Deleted</strong>. Workflow history is retained.</p>
            </div>
            <div class="modal-footer">
